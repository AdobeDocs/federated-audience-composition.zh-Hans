...
购买联合受众构成加载项时，您有权使用两个沙盒。 有关任何其他沙盒配置请求，请联系您的Adobe代表。
...
* 联合受众组合当前不可供客户[摄取运行状况数据](https://experienceleague.adobe.com/zh-hans/docs/events/customer-data-management-voices-recordings/governance/healthcare-shield){target="_blank"}使用。 [了解详情](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer/using/audiences-profiles-identities/audiences/about-audiences){target="_blank"}
