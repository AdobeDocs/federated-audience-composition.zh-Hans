...
* **轮廓扩充用例现已支持增量更新。**
  ...
  有关使用保存配置文件活动的更多信息，请参阅活动指南](/help/compositions/activities.md#save-profiles)的[保存配置文件部分。
...
* **Amazon Redshift 安全连接**
  ...
  在此新版本中，联合受众组合支持到Amazon Redshift数据库的安全PrivateLink连接。 [了解详情](../connections/home.md#amazon-redshift)
