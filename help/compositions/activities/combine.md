...
>title="差集规则"
>abstract="必要时，您可以操作集客表。事实上，要从另一个模式（也称为定位维度）中排除目标，必须将此目标返回到与主目标相同的模式。 为此，请单击 **添加规则** 在E **排除规则** 部分，并指定方案更改条件。 数据协调是通过属性或联接来执行的。"
...
>title="差集规则"
>abstract="必要时，您可以操作集客表。事实上，要从另一个模式（也称为定位维度）中排除目标，必须将此目标返回到与主目标相同的模式。 为此，请单击 **添加规则** 在 **排除规则** 部分，并指定方案更改条件。 数据协调是通过属性或联接来执行的。"
...
1. 必要时，您可以操作集客表。事实上，要从其他模式中排除某个目标，必须将该目标返回到与主目标相同的模式。 为此，请单击 **添加规则** 在 **排除规则** 部分，并指定方案更改条件。 通过属性或连接执行数据协调。 <!-- pas compris-->
